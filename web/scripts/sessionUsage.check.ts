...
eq(
  ...
  accumulateUsage(null, { input_tokens: 100, output_tokens: 5 }),
  { input_tokens: 100, output_tokens: 5, cache_read_tokens: 0, cache_write_tokens: 0 },
);
eq(
  'accumulate keeps summing',
  accumulateUsage(
    { input_tokens: 100, output_tokens: 5, cache_read_tokens: 90, cache_write_tokens: 1 },
    { input_tokens: 250, output_tokens: 7, cache_read_tokens: 240 },
  ),
  { input_tokens: 350, output_tokens: 12, cache_read_tokens: 330, cache_write_tokens: 1 },
);
